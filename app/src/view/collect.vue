            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    <tr :key="item._id" v-for="(item,index) in List">
                        ...
                        <td class="phwhite">
                            <input v-if="power=='rw'" class="text" type="text" placeholder="请输入说明..." v-model="item.description" />
                            <span v-if="power!='rw'">{{item.description}}</span>
                            </td>
                        <!-- <td>
...
<script>
    ...
    export default {
        ...
        computed: {
            power: function() {
                //权限
                return this.$store.state.login_module.userinfo.pri.caiji
            },
            pagecount: function() {
                //页面总数 （每页10个）
