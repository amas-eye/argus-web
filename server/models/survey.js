...
// 告警趋势 
let alert_trend = new Schema({
    start_time: Number, //开始时间
    end_time: Number, //结束时间
    check_time: Number, //更新时间
    alert_total: Number, //告警总次数
    period_alert_produce: Number, //时间内告警次数
    period_alert_canel: Number //时间内撤销告警次数
})
...
module.exports = {
    ...
    alert_trend: connections.argus_statistics.model('alert_trend', alert_trend, 'alert_trend'), //告警趋势
